                ...
                <tbody class="tableBodySlide">
                    @foreach ($painelAeros as $pn)
                        <tr>
                            ...
                            <td class="column4">{{ \Carbon\Carbon::parse($pn[0])->format('d/m/Y') }} - {{ \Carbon\Carbon::parse($pn[0])->format('H:m')}}hs </td>
                            <td class="column5">
                            @if($pn[1] != null)
                            {{ \Carbon\Carbon::parse($pn[1])->format('d/m/Y') }} - {{ \Carbon\Carbon::parse($pn[1])->format('H:m')}}hs
                            @endif
                            </td>
                            <td class="column6">
                                @if($pn[5] == 1)
