<div>
    <h2>Olá, </h2>
    <p>As atividades abaixo estão vencidas e sem previsão de conclusão ou com a previsão expirada:</p>
...
<br>
    <p>Acesse a ferramenta <a href="http:\\encerramentocontabil.sicredi.net">Encerramento Contábil</a> para cadastrar a previsão ou concluir suas atividades</p>
    <br>
